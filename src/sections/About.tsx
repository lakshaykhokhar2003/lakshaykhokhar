                ...
                <div className="col-span-1 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        <div>
                            ...
                            <p className="grid-subtext">With 12 years of experience in building products and brands, I
                                have
                                worked with startups and enterprises to create digital products that are user-friendly
                                and
                                scalable.</p>
                        </div>
                    </div>
